...
public class MnistManager { 
    ...
    public void writeImageToVectorConvolutional(int numImages, String convFileName) throws IOException { 
        ...
        try { 
        	...
        	for(int index=1;index<=numImages;index++){
	            ...
	            vectorOutImages.write(new Integer(label).toString());
	            //añadimos el valor de cada pixel
	            for (int i = 0; i < rows; i++) { 
	                ...
	                vectorOutImages.write(s.toString());
	                
	            }
	            vectorOutImages.write("\n");
        	}
        } finally { 
            vectorOutImages.close();
        } 
    ...
    public void writeImageToVector(int numImages, String ppmFileName) throws IOException { 
        ...
        int rows;
        int cols;
        log.debug("Write Image To Vector: "+numImages);
        try { 
